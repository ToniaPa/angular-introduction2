...
export class CrudCreateExampleComponent {
  ...
  // αυτό που βλέπουμε για πρώτη φορά είναι ότι στο form έχουμε nesting: στο phoneNumber (που είναι μέσα στο κυρίως formgroup) είναι form array όπου μέσα έχουμε μέσα ένα form group 
  // όπως και το adress είναι ένα formgroup μέσα στο κυρίως formgroup
  form = new FormGroup({
    givenName: new FormControl('', Validators.required),
    surName: new FormControl('', Validators.required),
    email: new FormControl('', [Validators.required, Validators.email]),
    afm: new FormControl('', Validators.required),
    phoneNumbers: new FormArray([ //το καινουργιο είναι το FormArray
      new FormGroup({
